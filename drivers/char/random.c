 ...
 * get_random_bytes() and get_random_{u8,u16,u32,u64,int,long}().
 *
 ...
 * get_random_bytes() and get_random_{u8,u16,u32,u64,int,long}(). Using
 * any of these functions without first calling this function means that
